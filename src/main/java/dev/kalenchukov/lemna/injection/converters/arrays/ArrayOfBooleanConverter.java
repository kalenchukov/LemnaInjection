...
public final class ArrayOfBooleanConverter implements Converting<Boolean[]>
{
	...
	@Override
	@Nullable
	public Boolean @Nullable [] convert(@Nullable final List<@Nullable String> value)
		throws UnableConverterException
	{
		...
		Boolean[] convertValue = new Boolean[value.size()];

		for (int elm = 0; elm < value.size(); elm++)
		{
			convertValue[elm] = new BooleanConverter().convert(Collections.singletonList(value.get(elm)));
		}
